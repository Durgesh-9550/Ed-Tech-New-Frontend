...
const FAQ = () => {
    ...
    const currentFAQs = faqData.find((category) => category.category === activeCategory)?.faqs || [];
    ...
    return (
        <div className="bg-gray-50 py-16 px-8">
            <div className="max-w-7xl mx-auto">
                ...
                {/* Categories */}
                <div className="flex justify-left gap-12 mb-8">
                    {faqData.map((category) => (
                        <button
                            key={category.category}
                            className={`py-3 px-5 rounded-full text-sm font-medium ${activeCategory === category.category
